...
public class AnagramController {
	...
	public ResponseEntity<Response> checkAnagram(@PathVariable String string1, @PathVariable String string2) {
		return new ResponseEntity<Response>(anagramService.checkAnagram(string1,string2), HttpStatus.OK);
	}
